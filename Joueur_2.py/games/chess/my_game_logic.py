...
*                       FILE NAME: my_game_logic.py                           *
*                       LAST EDITTED: 4/15/2021                                *
*   FILE DESCRIPTION:  This file contains functions for chess ai. Functions    *
*   are generating valid moves for each chess figure, as well as all moves     *
*   together for all the figures. There is also a function that is going to    *
*   parse FEN string from chess ai and cnvert it into a sD array, and print    *
*   function that is going to print that array to the console.                 *
*                                                                              *
********************************************************************************
'''
